...
I've also create a function to fit our benchmark model, Tao's Vanilla energy model [@Hong2010-cy]. It has been used in several GEFComs (including GEFCom2017) and is the go-to energy forecasting benchmark model due to its ubiquity and ease of use. Note that we do not carry out any cross-validation
...
We now have this data frame which contains our training data, cross-validation results and final model for each zone.
...
In the next post we will create weather and residual simulations. Hierarchical reconciliation will be used to create cohesive probabilistic forecasts.

<!-- For the efficient among you, here is all the code created to this point in one convenient chunk. -->
