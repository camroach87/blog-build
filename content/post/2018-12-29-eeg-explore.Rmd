...
I wrote my own function to loop through the data and find the start and end indexes of each event. Decided to use `C++` as it was about thirty times faster when I benchmarked against equivalent `R` code and I've been looking for an excuse to play around with `Rcpp`...
...
Now I can plot the EEG time series and the event start and end times.
